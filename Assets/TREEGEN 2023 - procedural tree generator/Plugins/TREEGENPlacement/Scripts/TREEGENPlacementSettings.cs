...
namespace TREEGEN.TREEGENPlacement
{
	...
	public class BrushSettings
	{
        ...
        public bool             multibrushPlacementSelectedSlot;
        ...
        {
            multibrushPlacementSelectedSlot = false;
        ...
        {            
            ...
            multibrushPlacementSelectedSlot = other.multibrushPlacementSelectedSlot;
	...
	public class Brush
	{
        ...
        public void SelectPrefab(int index)
        {
            ...
            {
                Undo.RegisterCompleteObjectUndo(TREEGENPlacementSettings.current, "PP: Select Prefab");
                selectedSlot = index;
            }
        }
        ...
        public int GetPrefabSlotForPlace()
        {
            ...
            if(settings.multibrushPlacementSelectedSlot)
            {
                return selectedSlot;
            }
        ...
        public void AssignPrefab(GameObject gameObject, int prefabSlot)
        {
            ...
            {
                Undo.RegisterCompleteObjectUndo(TREEGENPlacementSettings.current, "PP: Assign Prefab");
        ...
        public void ClearPrefab(int index)
        {
            ...
            {
                Undo.RegisterCompleteObjectUndo (TREEGENPlacementSettings.current, "PP: Clear Prefab Slot");
	...
	public class Tab
	{
        ...
        public void SelectBrush(int brushIndex)
        {
            if (brushIndex >= 0 && brushIndex < brushes.Count)
            {
                ...
                {
                    Undo.RegisterCompleteObjectUndo (TREEGENPlacementSettings.current, "PP: Selection Change");
        ...
        public void InsertSelectedBrushes(int index, bool after)
        {
            ...
            {
                Undo.RegisterCompleteObjectUndo (TREEGENPlacementSettings.current, "PP: Move Brush(es)");
        ...
        public void DuplicateSelectedBrushes()
        {
            ...
            Undo.RegisterCompleteObjectUndo(TREEGENPlacementSettings.current, "PP: Duplicate Brush(es)");
        ...
        public void DeleteSelectedBrushes()
        {
            ...
            Undo.RegisterCompleteObjectUndo (TREEGENPlacementSettings.current, "PP: Delete Brush(es)");
        ...
        public void ResetSelectedBrushes()
        {
            ...
            Undo.RegisterCompleteObjectUndo (TREEGENPlacementSettings.current, "PP: Reset Brush(es)");
        ...
        {
            Undo.RegisterCompleteObjectUndo (TREEGENPlacementSettings.current, "PP: Set Brush(es) Tag");
		...
		{
			Undo.RegisterCompleteObjectUndo (TREEGENPlacementSettings.current, "PP: Arrange Brushes By Name");
    ...
    //
    // class TREEGENPlacementSettings
    //
    public class TREEGENPlacementSettings : ScriptableObject
    {
        ...
        // Common settings 
        public bool             PlacementOnSelected;
        ...
        public static TREEGENPlacementSettings current = null;


        public TREEGENPlacementSettings()
        {
            ResetCommonSettings();
        ...
        {
            maxBrushRadius          = 50.0f;
            maxBrushSpacing         = 20.0f;
        ...
        {
            Undo.RegisterCompleteObjectUndo (TREEGENPlacementSettings.current, "PP: Move Tab");
